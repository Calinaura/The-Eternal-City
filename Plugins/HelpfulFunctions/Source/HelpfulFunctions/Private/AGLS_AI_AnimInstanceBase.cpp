...
FPoseSearchQueryTrajectory UAGLS_AI_AnimInstanceBase::GenerateTrajectory_Implementation(int HistoryCount, float InPredictionInterval, int PreditionCount)
{
	...
	UPoseSearchTrajectoryLibrary::PoseSearchGenerateTrajectory(this, TrajectoryConfigIdle, dt, Trajectory, PreviousDesiredControllerYawC, OutTrajectory, -1.0, HistoryCount, InPredictionInterval, PreditionCount);
